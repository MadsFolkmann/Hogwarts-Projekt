...
public class Course {
    ...
    public String toString() {
        StringBuilder result = new StringBuilder("src.data.Course:\n");
        result.append("src.data.Subject: ").append(subject.getName()).append("\n");
        if (teacher != null) {
            result.append("src.edu.generic.Teacher: ").append(teacher.getFullName()).append("\n");
        } else {
            result.append("src.edu.generic.Teacher: No teacher assigned\n");
        }
